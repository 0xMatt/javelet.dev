...
import {EyeIcon, EyeOffIcon, Github, Lock, Mail} from "lucide-react";
                                ...
                                <div className="grid gap-6">
                                    <div className="grid gap-3">
                                        ...
                                        <div
                                            ...
                                            <Mail size={14} className="h-5 w-5 text-muted-foreground"/>
                                            <Input
                                                id="email"
                                                type="email"
                                                name="email"
                                    ...
                                    <div className="grid gap-3">
                                        ...
                                        <div
                                            ...
                                            <Lock size={14} className="h-5 w-5 text-muted-foreground"/>
                                            <Input
                                                id="password"
                                                name="password"
