...
export default function CardSkeleton({className}: {className?: string}) {
    return (
        <Card
            className={cn("@container/card relative border-sidebar-border/90 dark:border-sidebar-border hover:scale-101 transition-all duration-300 animate-pulse", className)}>
            <PlaceholderPattern
